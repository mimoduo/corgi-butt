	...
	<ul class="main_nav_list" aria-label="Site Navigation">
		...
		<li class="js-main-nav-item-<?=$x?> main_nav_item<?php if ($has_children) { ?> main_nav_item_has_children<?php } if ($active) { ?> active<?php } ?>">
			<div class="main_nav_item_wrapper">
				...
				?>
				<button class="js-swap js-main-nav-toggle main_nav_toggle" data-swap-target=".js-main-nav-item-<?=$x?>" data-swap-group="main_nav" aria-label="<?=$item["title"]?> Submenu">
					<span class="main_nav_toggle_icon"><?=icon($icon)?></span>
				</button>
				<?php
					}
				?>
			...
			<ul class="js-main-nav-children main_nav_children" aria-label="submenu">
				...
				<li class="main_nav_child_item">
					<a class="main_nav_child_link" href="<?=$child["link"]?>"<?php if ($child["new_window"]) { ?> target="_blank"<?php } ?> itemprop="url">
						<span class="main_nav_child_link_label" itemprop="name"><?=$child["title"]?></span>
					</a>
				</li>
				<?php
					}
